 ...
 * Settings
 */
var globalSettings = { color: "#ffffff", isClosing: false };
...
function startClicked() {
    ...
    if (settings === null) {
      settings = {
        particles: {
          ...
          velocity: 3, // particle velocity in pixels/sec
  ...
  function flashScreen() {
    const canvas = document.getElementById("flashScreen");
    canvas.style.display = "block";
    canvas.style.animation = "flash 1.5s";
    setTimeout(function () {
  ...
  closeBtn.onclick = async function () {
    ...
    beatingHeart(heart, {
      particles: {
        ...
        effect: 15, // play with this for a nice effect
